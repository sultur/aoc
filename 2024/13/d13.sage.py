...
_sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_10000000000000 = Integer(10000000000000)
import sys
import re
...
COST_VEC = vector((_sage_const_3 , _sage_const_1 ))
...
def solve(machine):
    ...
    return COST_VEC * x if all(c.is_integer() for c in x) else _sage_const_0 
...
# Part 2
SCALING_FACTOR = _sage_const_10000000000000 
